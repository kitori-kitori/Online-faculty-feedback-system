...
?>
       ...
       <div class="row">
                ...
                <form name="sentMessage" method="post" id="contactForm" novalidate>
                  <?php echo @$err; ?>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Message:</label>
                            <textarea rows="10" name="msg" cols="100" class="form-control" id="message" required data-validation-required-message="Please enter your message" maxlength="999" style="resize:yes"></textarea>
                        </div>
                    </div>
                    <div id="success"></div>
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
                    Block C4<br>Kijitonyama, Dar es Salaam 90210<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (255) 634674590</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="kitori1000@gmail.com">kitori1000@gmail.com</a>
                </p>
