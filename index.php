...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				...
				This is a simple online System which will simply allow university students to rate their lectures as well as faculties.
				a student will be registered into the system,rate[0 - 5] make a comment,contacting their lectures
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed by <a href="https://twitter.com/sharifu_kitori">kitori</a> </span>
	</div>
    <!-- jQuery -->
